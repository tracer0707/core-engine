...
namespace Core
{
	class InputManager
	{
		...
		private:
			...
			std::pair<int, int> mouseDir = {0, 0};
			std::pair<int, int> mouseWheel = {0, 0};
			std::pair<int, int> mousePos = {0, 0};
			std::pair<int, int> relativeMousePos = {0, 0};

			std::unordered_map<int, bool> keyStates;
			std::unordered_map<int, bool> keyDownStates;
			std::unordered_map<int, bool> keyUpStates;

			bool mouseStates[32] = {false};
			bool mouseDownStates[32] = {false};
			bool mouseUpStates[32] = {false};
